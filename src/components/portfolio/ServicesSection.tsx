      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-8">
        <div className="mb-16 text-center sm:mb-20">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2">
            <Rocket className="h-4 w-4 text-teal-400" aria-hidden />
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {/* AI Strategy */}
          <div className="service-card group relative cursor-default overflow-hidden rounded-3xl border border-white/10 bg-surface-900 p-8 text-center hover:border-orchid-400/35 hover:bg-surface-800">
            ...
            <div className="relative z-10">
              ...
              <h3 className="font-display mb-3 text-lg tracking-tight text-white">
                AI Strategy & Consulting
              </h3>
              <p className="text-sm leading-relaxed text-surface-200/40">
          ...
          {/* Business */}
          <div className="service-card group relative cursor-default overflow-hidden rounded-3xl border border-white/10 bg-surface-900 p-8 text-center hover:border-teal-400/35 hover:bg-surface-800">
          ...
          {/* Data */}
          <div className="service-card group relative cursor-default overflow-hidden rounded-3xl border border-white/10 bg-surface-900 p-8 text-center hover:border-amber-400/35 hover:bg-surface-800">
          ...
          {/* Web Dev */}
          <div className="service-card group relative cursor-default overflow-hidden rounded-3xl border border-white/10 bg-surface-900 p-8 text-center hover:border-coral-400/35 hover:bg-surface-800">
