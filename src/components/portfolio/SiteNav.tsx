      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-8 sm:py-4">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <Link
            id="nav-cta-link"
            href="/#contact"
            className="inline-flex rounded-full bg-gradient-to-r from-coral-500 to-amber-500 px-5 py-2.5 text-sm font-bold text-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-coral-500/25"
          >
            Let&apos;s Talk
          </Link>
        </div>
      ...
      >
        <div className="mx-auto flex max-w-7xl flex-col gap-1 px-4 py-4 sm:px-8">
          ...
          <Link
            ...
            href="/#contact"
            className="mt-2 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-coral-500 to-amber-500 px-5 py-3.5 text-base font-bold text-white transition-all duration-300 hover:shadow-lg hover:shadow-coral-500/25"
            onClick={closeMenu}
          >
            Let&apos;s Talk
          </Link>
