  ...
  return (
    <section id="contact" className="relative py-20 sm:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-8">
        <div className="relative overflow-hidden rounded-[2rem] border border-surface-200 bg-white shadow-xl shadow-surface-950/5">
          ...
          <div className="relative z-10 px-6 py-14 text-center sm:px-16 sm:py-20">
            ...
            <h2 className="font-display mb-6 text-4xl tracking-tight text-surface-900 sm:text-5xl xl:text-6xl">
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-3 rounded-full border border-surface-300 px-8 py-4 font-bold text-surface-900 transition-all duration-300 hover:bg-surface-50"
              >
