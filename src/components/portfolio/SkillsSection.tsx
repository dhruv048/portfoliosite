...
export function SkillsSection() {
	return (
		<section id="skills" className="relative bg-surface-950 py-16 sm:py-32">
			<div className="absolute left-0 right-0 top-0 h-px bg-linear-to-r from-transparent via-surface-700 to-transparent" />
			...
			<div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-8">
				<div className="mb-12 text-center sm:mb-20">
					...
					<p className="mx-auto max-w-2xl text-base text-surface-300 sm:text-lg">
						...
						<div className="relative z-10">
							<div className="mb-8 flex items-center gap-5">
								<div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-surface-700 bg-surface-800 transition-colors group-hover:border-orchid-400/30 group-hover:bg-orchid-400/10">
									<BrainCircuit className="h-8 w-8 text-surface-300 transition-colors group-hover:text-orchid-400" />
								</div>
								<div>
									<h3 className="font-display text-xl tracking-tight text-white sm:text-2xl">
										AI & Data Skills
									</h3>
									<p className="text-base text-surface-500 group-hover:text-orchid-400/70">
							...
							<div className="grid grid-cols-1 gap-3 min-[420px]:grid-cols-2 min-[420px]:gap-4">
								{(
									...
									<div
										key={label}
										className="flex items-center gap-3 rounded-xl border border-surface-800 bg-surface-950/50 px-4 py-3 transition-all sm:px-5 sm:py-4 group-hover:border-orchid-400/20"
									>
										<Icon className="h-5 w-5 text-surface-500 transition-colors group-hover:text-orchid-400" />
										<span className="text-base font-medium text-surface-300 group-hover:text-white">
											{label}
										</span>
									</div>
								))}
						...
						<div className="relative z-10">
							<div className="mb-8 flex items-center gap-5">
								<div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-surface-700 bg-surface-800 transition-colors group-hover:border-teal-400/30 group-hover:bg-teal-400/10">
									<Briefcase className="h-8 w-8 text-surface-300 transition-colors group-hover:text-teal-400" />
								</div>
								<div>
									<h3 className="font-display text-xl tracking-tight text-white sm:text-2xl">
										Business & Strategy
									</h3>
									<p className="text-base text-surface-500 group-hover:text-teal-400/70">
										Leadership & Strategy
									</p>
								</div>
							</div>
							<div className="grid grid-cols-1 gap-3 min-[420px]:grid-cols-2 min-[420px]:gap-4">
								{(
									...
									<div
										key={label}
										className="flex items-center gap-3 rounded-xl border border-surface-800 bg-surface-950/50 px-4 py-3 transition-all sm:px-5 sm:py-4 group-hover:border-teal-400/20"
									>
						...
						<div className="relative z-10">
							<div className="mb-8 flex items-center gap-5">
								<div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-surface-700 bg-surface-800 transition-colors group-hover:border-amber-400/30 group-hover:bg-amber-400/10">
									<Wrench className="h-8 w-8 text-surface-300 transition-colors group-hover:text-amber-400" />
								</div>
								<div>
									<h3 className="font-display text-xl tracking-tight text-white sm:text-2xl">
										Tools & Tech
									</h3>
									<p className="text-base text-surface-500 group-hover:text-amber-400/70">
							...
							<div className="grid grid-cols-1 gap-3 min-[420px]:grid-cols-2 min-[420px]:gap-4">
								{(
									...
									<div
										key={label}
										className="flex items-center gap-3 rounded-xl border border-surface-800 bg-surface-950/50 px-4 py-3 transition-all sm:px-5 sm:py-4 group-hover:border-amber-400/20"
									>
						...
						<div className="relative z-10">
							<div className="mb-8 flex items-center gap-5">
								<div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-surface-700 bg-surface-800 transition-colors group-hover:border-coral-400/30 group-hover:bg-coral-400/10">
									<Heart className="h-8 w-8 text-surface-300 transition-colors group-hover:text-coral-400" />
								</div>
								<div>
									<h3 className="font-display text-xl tracking-tight text-white sm:text-2xl">
										Soft Skills
									</h3>
									<p className="text-base text-surface-500 group-hover:text-coral-400/70">
							...
							<div className="grid grid-cols-1 gap-3 min-[420px]:grid-cols-2 min-[420px]:gap-4">
								{(
									...
									<div
										key={label}
										className="flex items-center gap-3 rounded-xl border border-surface-800 bg-surface-950/50 px-4 py-3 transition-all sm:px-5 sm:py-4 group-hover:border-coral-400/20"
									>
